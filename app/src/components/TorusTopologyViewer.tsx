        ...
        <div className="relative col-span-2 overflow-hidden rounded-xl border border-ink-700 bg-ink-950 p-4">
          ...
          <div className="relative flex h-80 w-full items-center justify-center cursor-grab active:cursor-grabbing">
            ...
            >
              ...
              {/* Logical Z1 Meridian Loop (Short Radius r Loop wrapping vertical section) */}
              {showZ1 && (
                <g>
              ...
              {/* Logical X1 Longitude Loop (Long Radius R Loop wrapping main circumference) */}
              {showX1 && (
                <g>
              ...
              {/* Contractible Error Loop (Small circle that shrinks to a point ∂e = 0) */}
              {showContractible && (
                <g>
